...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.G:\FullStackCourse\Project\task-manager\public\storage' => 'string',
...
'filesystems.links.G:\\FullStackCourse\\Project\\task-manager\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'web','api',);
        registerArgumentsSet('routes', 'dashboard','tasks.index','tasks.create',
'tasks.store','tasks.show','tasks.edit','tasks.update','tasks.destroy',
'tasks.toggleComplete','tasks.quickStore','profile.edit','profile.update','profile.destroy',
'password.update','users.export','users.import','activities.undo','google.redirect',
'google.callback','register','login',
...
'auth.verify-email','components.application-logo','components.auth-session-status','components.danger-button','components.dashboard.activity-log-widget',
'components.dashboard.stats-card','components.dashboard.task-list-widget','components.dropdown','components.dropdown-link','components.input-error',
'components.input-label','components.modal','components.nav-link','components.primary-button','components.responsive-nav-link',
'components.secondary-button','components.text-input','components.ui.welcome-card','dashboard','layouts.app',
'layouts.guest','layouts.navigation','profile.edit','profile.partials.delete-user-form','profile.partials.update-notification-settings-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','tasks.create','tasks.edit','tasks.index',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','GOOGLE_CLIENT_ID',
